...
public class Campeonato {
    ...
    public static Campeonato crearCampeonatoRandom(int numeroCarreras){
        ...
        List<String> nombresLugares = Arrays.asList("Australia", "Bahrein", "China", "Espania", "Monaco", "Canada", "Francia", "Austria", "Reino Unido", "Holanda"
                                                    , "Belgica", "Italia", "Rusia", "Turquia", "Estados Unidos", "Mexico", "Arabia Saudita", "Abu Dhabi"); 
        List<String> nombresPistas = Arrays.asList("Albert Park", "Bahrain International Circuit", "Shanghai International Circuit", "Circuit de Barcelona-Catalunya", "Circuit de Monaco", 
                                                    "Circuit Gilles Villeneuve", "Circuit Paul Ricard", "Red Bull Ring", "Silverstone Circuit", "Circuit Zandvoort", "Circuit de Spa-Francorchamps",
                                                        "Autodromo Nazionale Monza", "Sochi Autodrom", "Istanbul Park", "Circuit of the Americas", "Autódromo Hermanos Rodríguez", "Jeddah Corniche Circuit",
                                                        "Yas Marina Circuit", "Hockenheimring", "Hungaroring", "Marina Bay Street Circuit", "Suzuka Circuit", "Baku City Circuit", "Circuit de Nevers Magny-Cours",
                                                        "Autódromo José Carlos Pace", "Kyalami Racing Circuit", "Watkins Glen International", "Anderstorp Raceway", "Imola Circuit");                       
